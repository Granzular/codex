async function fetchSalesData() {
  ...
  const res = await fetch('http://localhost:8080/myadmin/api/live-sales/');  // change URL to your view
...
async function renderChart() {
  ...
  const chart = new ApexCharts(document.querySelector("#todo-progress-chart"), options);
  chart.render();
}
